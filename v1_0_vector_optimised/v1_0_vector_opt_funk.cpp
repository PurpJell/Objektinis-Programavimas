...
void dalinti(vector<studentas>& mas, vector<studentas> &kieti, vector<studentas> &prasti, int &kietiCnt, int &prastiCnt)
{
	...
	kietiCnt = kieti.size();
	prastiCnt = prasti.size();
}

void dalinti2(vector<studentas> &mas, vector<studentas> &kieti, int &kietiCnt, int &prastiCnt)
{
	...
	kietiCnt = distance(kieti.begin(), kieti_end);
