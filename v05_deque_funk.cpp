...
int partition(deque<studentas>& mas, int start, int end) // kai vardai nera sabloniniai
{
...
void quicksort(deque<studentas>& mas, int start, int end) // kai vardai nera sabloniniai
{
	if (start >= end) return;
